...
const transporter = nodemailer.createTransport({
    ...
    auth: {
        ...
        pass: 'kqdh zsey rhmj oqcy'  // your app password here
    }
});
...
module.exports = (db) => {
    ...
    // ============================================================
    // CALENDAR EVENT REMINDERS — runs every day at 8:00 AM
    // ============================================================
      ...
      `, [tomorrowStr]);
            ...
            for (const event of events) {
                ...
                await transporter.sendMail({
                    ...
                    to: event.email,
                    subject: `JobTrack Reminder: ${event.title} tomorrow`,
                    html: `
            <div style="font-family: sans-serif; max-width: 480px; margin: 0 auto;">
              <h2 style="color: #0c3e54;">Upcoming Event Reminder</h2>
              <p>Hi ${event.full_name},</p>
              <p>You have an event scheduled for <strong>tomorrow</strong>:</p>
              <div style="background: #f0f4f8; border-radius: 10px; padding: 16px; margin: 16px 0;">
                ...
                <p style="margin: 0; color: #64748b;">📅 ${tomorrowStr} &nbsp;|&nbsp; 🕐 ${time}</p>
